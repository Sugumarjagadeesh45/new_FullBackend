...
//         console.log(`📍 Drop: ${JSON.stringify(drop)}`);
//         console.log(`🚗 Vehicle type: ${vehicleType}`);
//         console.log(`🌍 User Geo Location Code (Pickup): Lat ${pickup.lat}, Lng ${pickup.lng}`);
//         console.log(`🌍 User Geo Location Code (Drop): Lat ${drop.lat}, Lng ${drop.lng}`);
...
//         console.log(`💾 Ride saved to MongoDB with ID: ${savedRide._id}`);
//         console.log(`💾 RAID_ID in saved document: ${savedRide.RAID_ID}`);
//         console.log(`💾 Saved user mobile: ${savedRide.userMobile || 'Not saved'}`);
...
//           timestamp: Date.now(),
//           _id: savedRide._id.toString(),
//           userLocation: { latitude: pickup.lat, longitude: pickup.lng } // Initial user location is pickup
//         };
...
//     // ✅ FIX: First check in-memory rides, then check database
//     let driverId = null;
...
//     // ✅ CRITICAL FIX: Send user location to the specific driver with proper data structure
//     const driverRoom = `driver_${driverId}`;
//     const locationData = {
//       rideId: rideId,
//       userId: userId,
//       lat: latitude,  // Changed from userLat to lat
//       lng: longitude, // Changed from userLng to lng
//       timestamp: Date.now()
//     };
...
//       pickup: ride.pickup,
//       drop: ride.drop,
//       userCurrentLocation: userCurrentLocation, // Include current user location
//       otp: ride.otp,
//       fare: ride.fare,
//       distance: ride.distance
//     };
